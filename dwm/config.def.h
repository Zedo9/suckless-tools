...
static const char *fonts[]          = { "CascadiaCode-Medium:size=10:antilias=true:autohint=true" };
static const char dmenufont[]       = "CascadiaCode-Medium:size=10:antilias=true:autohint=true";
...
static Key keys[] = {
	...
	{ MODKEY,                       XK_ccedilla,setgaps,        {.i = -2 } },
