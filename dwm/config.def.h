...
static const char *fonts[]          = { "JetBrainsMono-Bold:size=11:antilias=true:autohint=true" };
static const char dmenufont[]       = "JetBrainsMono-Bold:size=11:antilias=true:autohint=true";
